...
public class GarbledEmailSolved implements Runnable {

	final String problem = "C";
//	final String filename = problem + "-sample";

//	 final String filename= problem+"-small-attempt0";
	 final String filename = "C:\\Mywork\\Temp\\codeJam\\MyInput\\GarbledEmail\\C-small-practice";
	...
	public void init() throws Exception {
		BufferedReader in = new BufferedReader(new FileReader(
				"C:\\Mywork\\Temp\\codeJam\\MyInput\\GarbledEmail\\garbled_email_dictionary.txt"));
	...
	public void run() {
		try {
			...
			out = new BufferedWriter(new FileWriter(filename + "solved.out"));
			solve_gcj();
			out.flush();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void main(String[] args) {
		...
		new Thread(new GarbledEmailSolved()).start();
